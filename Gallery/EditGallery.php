...
if(!$connected){
    $GalleryMessage.= sfUtils::sfPromptMessage("Snowflakes could not connect to database.".$SFconnects->getMessage(),'error');
}
                                        ...
                                        foreach ($GalleryDisplayThumb as $counter => $imageThumbLink) {
                                            ...
                                            <li>
                                                ...
                                                if ($counter != $total) {
                                                    ...
                                                    ?>
                                                    <a class="ViewThumb" title="Make Album Cover" href="<?php echo $thecoverlink; ?>"> <img src="../resources/images/Icons/Gallery.png" alt="cover" /></a>
                                                <?php } ?>
