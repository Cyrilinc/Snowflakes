...
<html ><!-- InstanceBegin template="/Templates/index.dwt" codeOutsideHTMLIsLocked="false" -->
    <head>
        ...
        <script type="text/javascript" src="../resources/Js/SnowflakesSSE.js"></script>
        <!--[if IE]>
                    ...
                    <div class="contactform">
                        <form action="<?php echo $editFormAction; ?>" method="post" enctype="multipart/form-data" name="form1" id="installForm">
                            <span id="spryTitle">
                                ...
                                <input type="text" name="title" value="" size="32" class="inputtext2 controls" placeholder="Event Title">
                            </span><br />
                            ...
                            <span id="spryBodytext">
                                ...
                                <iframe name="richTextField" id="richTextField Pmessage2" style="min-height:300px;" class="sfeditor_textbox inputtext2 controls"></iframe><br>
                                <textarea style="display:none;" name="body_text" cols="50" rows="8" class="controls" id="Pmessage2" placeholder="Event description"></textarea>
                            ...
                            <span id="sprystartTime" class="spanside">
                                ...
                                <input type="time" name="event_time" placeholder="Event start time eg 14:25" class="inputtext2 controls">
                            </span>
                            <span id="sprystartDate" class="spanside">
                                <span class="textfieldRequiredMsg">Event start date is required.</span>
                                <input type="date" name="event_date" id="snowdate" placeholder="Event start date e.g DD/MM/YYYY" class="inputtext2 controls">
                            </span>
                            <span id="spryendTime" class="spanside">
                                <span class="textfieldRequiredMsg">Event end time is required.</span>
                                <input type="time" name="end_time" placeholder="Event end time eg 14:25" class="inputtext2 controls">
                            </span>
                            <span id="spryendDate" class="spanside">
                                <span class="textfieldRequiredMsg">Event end date is required.</span>
                                <input type="date" name="end_date" id="snowdate2" placeholder="Event end date e.g DD/MM/YYYY" class="inputtext2 controls">
                            </span><br />
                            <div id="sprytLocation">
                                <span class="textfieldRequiredMsg">A Location is required.<br /></span>
                                <input type="text" id="pac-input" name="location" placeholder="Enter a location" class="inputtext3 controls">
                            ...
                            <br />
                            <input type="submit" value="Add Event" class="NewButton" onClick="transferEditorData('form1');">
                            <input type="hidden" name="lat_long" id="latlong" value="">
...
?>" />
        ...
        <script type="text/javascript">
            ...
            var sprytextfield2 = new Spry.Widget.ValidationTextField("sprytLocation", "none", {validateOn: ["blur"]});
